...
<div class="flex w-full gap-x-12 items-center justify-between">
	...
	<div class="md:flex gap-x-3 icon-a hidden  transform !scale-75 xl:!scale-100">
		<div class="flex flex-col  justify-between gap-3 -rotate-12 mb-3 container-a">
			<span
				class="p-4 icon-one-a rounded-md shadow-lg font-bold font-head-home text-3xl  bg-white flex items-center gap-4 border border-gray-900 dark:border-gray-700 dark:bg-gray-800"
				style="opacity:0; transform:translateY(20px);"
				><Icon name="javascript" width="40" height="40" color="#f0db4f" />
			</span>
			<span
				class="p-4 rounded-md icon-one-a shadow-lg font-bold font-head-home text-3xl bg-white flex items-center gap-4 border border-gray-900 dark:border-gray-700 dark:bg-gray-800"
				style="opacity:0; transform:translateY(20px);"
