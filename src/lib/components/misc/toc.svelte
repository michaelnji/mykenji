...
<div class="p-6  bg-gray-100 border-opacity-30  w-full border-gray-900 max-h-[35rem] overflow-y-auto rounded-2xl   dark:bg-gray-900" in:fly={{y:100, duration:400, delay:1600}}>
